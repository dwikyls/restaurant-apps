...
const createRestaurantDetailTemplate = (restaurant) => `
  ...
  <div class="restaurant__info">
    <h3>Information</h3>
    <h4>Address</h4>
    <p tabindex="0"><i class="fa fa-map-marker" aria-hidden="true"></i> ${restaurant.address}, ${restaurant.city}</p>
    <h4>Rating</h4>
    <p tabindex="0">${restaurant.rating} ${'⭐️'.repeat(restaurant.rating)}</p>
    <h4>Categories</h4>
    <ul tabindex="0">
  ...
  <div class="restaurant__overview">
    <h3>Overview</h3>
    <p style="text-align: justify;" tabindex="0">${restaurant.description}</p>
  </div>
  ...
  <div class="restaurant-item">
    <div class="restaurant-item__header">
        ...
        <div class="restaurant-item__header__address">
            <p><span class="restaurant-item__header__location"><i class="fa fa-map-marker" aria-hidden="true"></i> ${restaurant.city}</span></p>
        </div>
    </div>
...
const createUserReviewTemplate = (restaurant) => `
  ${Array.from(restaurant.customerReviews, (reviewer) => `
    ...
    <p class="text-muted" tabindex="0">${reviewer.date}</p>
  `)}
`;
